...
$(LIB_CV_DIR)/tensorflow/lite/experimental/microfrontend/lib/fft.c \
$(LIB_CV_DIR)/tensorflow/lite/experimental/microfrontend/lib/fft_util.c \
$(LIB_CV_DIR)/tensorflow/lite/experimental/microfrontend/lib/filterbank.c \
$(LIB_CV_DIR)/tensorflow/lite/experimental/microfrontend/lib/filterbank_util.c \
$(LIB_CV_DIR)/tensorflow/lite/experimental/microfrontend/lib/frontend.c \
$(LIB_CV_DIR)/tensorflow/lite/experimental/microfrontend/lib/frontend_util.c \
$(LIB_CV_DIR)/tensorflow/lite/experimental/microfrontend/lib/log_lut.c \
$(LIB_CV_DIR)/tensorflow/lite/experimental/microfrontend/lib/log_scale.c \
$(LIB_CV_DIR)/tensorflow/lite/experimental/microfrontend/lib/log_scale_util.c \
$(LIB_CV_DIR)/tensorflow/lite/experimental/microfrontend/lib/noise_reduction.c \
$(LIB_CV_DIR)/tensorflow/lite/experimental/microfrontend/lib/noise_reduction_util.c \
...
ifeq ($(ALGO_TYPE), TFLITE_MICRO_HIMAX_PERSON)
	...
	ifeq (HX_VIP_YOMO, $(findstring HX_VIP_YOMO, $(APPL_DEFINES)))
		ifeq (HX_VIP_YOMO_20210115_E_PANA, $(findstring HX_VIP_YOMO_20210115_E_PANA, $(APPL_DEFINES)))
			...
			LIB_CV_CCSRCS += $(LIBRARIES_ROOT)/cv/himax/model/PANA01_IOULoss05_borderValue128_YOMOv4_tf2_4.cc
			LIB_CV_CCSRCS += $(LIBRARIES_ROOT)/cv/himax/model/YOMO_UFPR_AMR_CR_x1_3_t2_rotate5_aug_ori_tf2_4.cc
		endif
	else
		LIB_CV_CCSRCS += $(LIBRARIES_ROOT)/cv/himax/model/yolo_PTQ_int8.cc
	endif
...
ifeq ($(TOOLCHAIN), mw)
	ifeq ($(ALGO_TYPE), TFLITE_MICRO_HIMAX_PERSON)
		...
		ifeq ($(ALGO_TYPE_AUDIO), CYBERON)
			...
			#override LINKER_SCRIPT_FILE := $(LIBRARIES_ROOT)/cv/himax/linker_script/linker_template_mw_tflitemicro_rtos_wo_audio.ld
			override LINKER_SCRIPT_FILE := $(LIBRARIES_ROOT)/cv/himax/linker_script/linker_template_mw_tflitemicro_wo_audio_M.ld
		endif
	endif
else
...
PREBUILT_MLI_LIB = $(EMBARC_ROOT2)\library\cv\tflitemicro_24\third_party\arc_mli_package\bin\himax_arcem9d_r16\release\libmli.a
else
MLI_LIB = $(BOARD_OUT_DIR)/$(BUILD_INFO)/libmli.a
PREBUILT_MLI_LIB = $(EMBARC_ROOT)/library/cv/tflitemicro_24/third_party/arc_mli_package/bin/himax_arcem9d_r16/release/libmli.a
endif
...
ifeq ($(ALGO_TYPE), TFLITE_MICRO_GOOGLE_PERSON)
	ifeq ($(TOOLCHAIN), mw)
		CV_PREBUILT_LIB = $(EMBARC_ROOT2)\library\cv\tflitemicro_24\prebuilt_lib\libtflitemicro_google_person.a
	else
		CV_PREBUILT_LIB = $(EMBARC_ROOT2)\library\cv\tflitemicro_24\prebuilt_lib\libtflitemicro_google_person_gnu.a
	endif
endif
ifeq ($(ALGO_TYPE), TFLITE_MICRO_HIMAX_PERSON)
	ifeq ($(TOOLCHAIN), mw)
		CV_PREBUILT_LIB = $(EMBARC_ROOT2)\library\cv\himax\prebuilt_lib\libtflitemicro_24_himax_person.a
	else
		CV_PREBUILT_LIB = $(EMBARC_ROOT2)\library\cv\himax\prebuilt_lib\libtflitemicro_24_himax_person_gnu.a
	endif
endif
else
ifeq ($(ALGO_TYPE), TFLITE_MICRO_GOOGLE_PERSON)
	ifeq ($(TOOLCHAIN), mw)
		CV_PREBUILT_LIB = $(EMBARC_ROOT)/library/cv/tflitemicro_24/prebuilt_lib/libtflitemicro_google_person.a
	else
		CV_PREBUILT_LIB = $(EMBARC_ROOT)/library/cv/tflitemicro_24/prebuilt_lib/libtflitemicro_google_person_gnu.a
	endif
endif
ifeq ($(ALGO_TYPE), TFLITE_MICRO_HIMAX_PERSON)
	ifeq ($(TOOLCHAIN), mw)
		CV_PREBUILT_LIB = $(EMBARC_ROOT)/library/cv/himax/prebuilt_lib/libtflitemicro_24_himax_person.a
	else
		CV_PREBUILT_LIB = $(EMBARC_ROOT)/library/cv/himax/prebuilt_lib/libtflitemicro_24_himax_person_gnu.a
	endif
endif
endif
