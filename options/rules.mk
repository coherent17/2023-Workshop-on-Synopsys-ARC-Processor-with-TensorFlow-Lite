...
all : $(APPL_FULL_NAME).elf copy_flash
...
ifeq ($(TOOLCHAIN), mw)
	$(CP) $(BOARD_OUT_DIR)\$(BUILD_INFO)\WEI_FW_mw_arcem9d_wei_r16.elf $(IMAGE_TOOL_INPUT_DIR2)\WEI_FW_mw_arcem9d_wei_r16.elf
	$(CP) $(BOARD_OUT_DIR)\$(BUILD_INFO)\WEI_FW_mw_arcem9d_wei_r16.map $(IMAGE_TOOL_INPUT_DIR2)\WEI_FW_mw_arcem9d_wei_r16.map
else
	$(CP) $(BOARD_OUT_DIR)\$(BUILD_INFO)\WEI_FW_gnu_arcem9d_wei_r16.elf $(IMAGE_TOOL_INPUT_DIR2)\WEI_FW_gnu_arcem9d_wei_r16.elf
	$(CP) $(BOARD_OUT_DIR)\$(BUILD_INFO)\WEI_FW_gnu_arcem9d_wei_r16.map $(IMAGE_TOOL_INPUT_DIR2)\WEI_FW_gnu_arcem9d_wei_r16.map
endif
else
ifeq ($(TOOLCHAIN), mw)
	$(CP) $(BOARD_OUT_DIR)/$(BUILD_INFO)/WEI_FW_mw_arcem9d_wei_r16.elf $(IMAGE_TOOL_INPUT_DIR)/WEI_FW_mw_arcem9d_wei_r16.elf
	$(CP) $(BOARD_OUT_DIR)/$(BUILD_INFO)/WEI_FW_mw_arcem9d_wei_r16.map $(IMAGE_TOOL_INPUT_DIR)/WEI_FW_mw_arcem9d_wei_r16.map
else
	$(CP) $(BOARD_OUT_DIR)/$(BUILD_INFO)/WEI_FW_gnu_arcem9d_wei_r16.elf $(IMAGE_TOOL_INPUT_DIR)/WEI_FW_gnu_arcem9d_wei_r16.elf
	$(CP) $(BOARD_OUT_DIR)/$(BUILD_INFO)/WEI_FW_gnu_arcem9d_wei_r16.map $(IMAGE_TOOL_INPUT_DIR)/WEI_FW_gnu_arcem9d_wei_r16.map
endif
endif
...
menuconfig :
	...
	@. $(IMAGE_GEN_TOOL_DIR)/menuconfig_v1.0.sh
...
ifeq ($(IC_PACKAGE_SEL), LQFP128)
	$(CP) $(EMBARC_ROOT2)\library\prebuilt_lib\libembarc_128pin.a $(BOARD_OUT_DIR)\$(BUILD_INFO)\libembarc.a
endif
ifeq ($(IC_PACKAGE_SEL), WLCSP38)
	$(CP) $(EMBARC_ROOT2)\library\prebuilt_lib\libembarc_38pin.a $(BOARD_OUT_DIR)\$(BUILD_INFO)\libembarc.a
endif
ifeq ($(IC_PACKAGE_SEL), QFP100)
	$(CP) $(EMBARC_ROOT2)\library\prebuilt_lib\libembarc_100pin.a $(BOARD_OUT_DIR)\$(BUILD_INFO)\libembarc.a
endif	
ifeq ($(IC_PACKAGE_SEL), QFN72)
	$(CP) $(EMBARC_ROOT2)\library\prebuilt_lib\libembarc_72pin.a $(BOARD_OUT_DIR)\$(BUILD_INFO)\libembarc.a
endif
else
ifeq ($(IC_PACKAGE_SEL), LQFP128)
	$(CP) $(EMBARC_ROOT2)\library\prebuilt_lib\libembarc_128pin_gnu.a $(BOARD_OUT_DIR)\$(BUILD_INFO)\libembarc.a
endif
ifeq ($(IC_PACKAGE_SEL), WLCSP38)
	$(CP) $(EMBARC_ROOT2)\library\prebuilt_lib\libembarc_38pin_gnu.a $(BOARD_OUT_DIR)\$(BUILD_INFO)\libembarc.a
endif
ifeq ($(IC_PACKAGE_SEL), QFP100)
	$(CP) $(EMBARC_ROOT2)\library\prebuilt_lib\libembarc_100pin_gnu.a $(BOARD_OUT_DIR)\$(BUILD_INFO)\libembarc.a
endif	
ifeq ($(IC_PACKAGE_SEL), QFN72)
	$(CP) $(EMBARC_ROOT2)\library\prebuilt_lib\libembarc_72pin_gnu.a $(BOARD_OUT_DIR)\$(BUILD_INFO)\libembarc.a
endif
endif
...
ifeq ($(IC_PACKAGE_SEL), LQFP128)
ifeq ($(TOOLCHAIN), mw)
	$(CP) $(EMBARC_ROOT)/library/prebuilt_lib/libembarc_128pin.a $(BOARD_OUT_DIR)/$(BUILD_INFO)/libembarc.a
else	
ifeq ($(OS_TYPE), )
	$(CP) $(EMBARC_ROOT)/library/prebuilt_lib/libembarc_128pin_gnu.a $(BOARD_OUT_DIR)/$(BUILD_INFO)/libembarc.a
else
	$(CP) $(EMBARC_ROOT)/library/prebuilt_lib/libembarc_128pin_gnu_os.a $(BOARD_OUT_DIR)/$(BUILD_INFO)/libembarc.a
endif	
endif	
endif
ifeq ($(IC_PACKAGE_SEL), WLCSP38)
	$(CP) $(EMBARC_ROOT)/library/prebuilt_lib/libembarc_38pin.a $(BOARD_OUT_DIR)/$(BUILD_INFO)/libembarc.a
endif
ifeq ($(IC_PACKAGE_SEL), QFP100)
	$(CP) $(EMBARC_ROOT)/library/prebuilt_lib/libembarc_100pin.a $(BOARD_OUT_DIR)/$(BUILD_INFO)/libembarc.a
endif	
ifeq ($(IC_PACKAGE_SEL), QFN72)
ifeq ($(TOOLCHAIN), mw)	
	$(CP) $(EMBARC_ROOT)/library/rebuilt_lib/libembarc_72pin.a $(BOARD_OUT_DIR)/$(BUILD_INFO)/libembarc.a
else	
ifeq ($(OS_TYPE), )
	$(CP) $(EMBARC_ROOT)/library/prebuilt_lib/libembarc_72pin_gnu.a $(BOARD_OUT_DIR)/$(BUILD_INFO)/libembarc.a
else
	$(CP) $(EMBARC_ROOT)/library/prebuilt_lib/libembarc_72pin_gnu_os.a $(BOARD_OUT_DIR)/$(BUILD_INFO)/libembarc.a
endif	
endif		
endif	
endif
...
$(SECURE_LIB) :
ifeq "$(HOST_OS)" "Windows"
	$(CP) $(EMBARC_ROOT2)\library\prebuilt_lib\liblibsecurity_r16.a $(BOARD_OUT_DIR)\$(BUILD_INFO)\liblibsecurity.a
else
	$(CP) $(EMBARC_ROOT)/library/prebuilt_lib/liblibsecurity_r16.a $(BOARD_OUT_DIR)/$(BUILD_INFO)/liblibsecurity.a
endif
